...
# 사이트별 쿠키 동의 완료 쿠키 (현재 capture.py에서 비활성화 상태, 최후의 수단으로 보관 중)
# 클릭 기반 처리(동의 버튼 클릭 / CSS 강제 숨김)로 해결이 안 되는 사이트가 나오면
# 여기에 등록하고 capture.py의 "[레이어 3 - 비활성화]" 주석을 해제할 것
# 형식: {'name': '쿠키명', 'value': '값'}
...
TARGET_URLS = [
    ...
    "https://www.navimro.com/p/K63528032/?srsltid=AfmBOopsEHt5iauyFMcmbmBC0zVhSuCYzx7G7U428j_ztRPmTQQt37uV",
    ...
    "https://itempage3.auction.co.kr/DetailView.aspx?itemno=F534934567",
